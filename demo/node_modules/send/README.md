...
the server.js HTTP request and the `path` is a urlencoded path to send (urlencoded,
...
The `pipe` method is used to pipe the response into the server.js HTTP response
