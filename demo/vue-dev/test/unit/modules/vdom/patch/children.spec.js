...
describe('vdom patch: children', () => {
  ...
  it('should remove a single text vue-example with updating children without keys', () => {
  ...
  it('should remove a single text vue-example when children are updated', () => {
    const vnode1 = new VNode('div', {}, undefined, 'one')
    const vnode2 = new VNode('div', {}, [
  ...
  it('should remove a text vue-example among other elements', () => {
    const vnode1 = new VNode('div', {}, [
      createTextVNode('one'),
      new VNode('span', {}, undefined, 'two')
    ])
