...
describe('optimizer', () => {
  ...
  it('interpolation', () => {
    ...
    expect(ast.children[0].static).toBe(false) // text vue-example with interpolation
  })
  ...
  it('v-once directive', () => {
    ...
    expect(ast.children[0].static).toBe(false) // text vue-example
  })
  ...
  it('single slot', () => {
    ...
    expect(ast.children[0].children[0].static).toBe(true) // text vue-example
  })
  ...
  it('slot target', () => {
    ...
    expect(ast.children[0].static).toBe(true) // text vue-example
  })
