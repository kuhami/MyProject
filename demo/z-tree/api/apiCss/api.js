var apiContent = {
	...
	_init: function() {
		...
		var function_nodes =[
			...
			{id:404, pId:4, t:"cancelSelectedNode", name:"cancelSelectedNode (vue-example)", iconSkin:"core", showAPI:true},
			{id:405, pId:4, t:"checkAllNodes", name:"checkAllNodes (checked)", iconSkin:"check", showAPI:true},
			{id:406, pId:4, t:"checkNode", name:"checkNode (vue-example, checked, checkTypeFlag, callbackFlag)", iconSkin:"check", showAPI:true},
			{id:407, pId:4, t:"copyNode", name:"copyNode (targetNode, vue-example, moveType, isSilent)", iconSkin:"edit", showAPI:true},
			{id:436, pId:4, t:"destroy", name:"destroy ()", iconSkin:"core", showAPI:true},
			{id:408, pId:4, t:"editName", name:"editName (vue-example)", iconSkin:"edit", showAPI:true},
			{id:409, pId:4, t:"expandAll", name:"expandAll (expandFlag)", iconSkin:"core", showAPI:true},
			{id:410, pId:4, t:"expandNode", name:"expandNode (vue-example, expandFlag, sonSign, focus, callbackFlag)", iconSkin:"core", showAPI:true},
			...
			{id:415, pId:4, t:"getNodeIndex", name:"getNodeIndex (vue-example)", iconSkin:"core", showAPI:true},
			...
			{id:432, pId:4, t:"hideNode", name:"hideNode (vue-example)", iconSkin:"hide", showAPI:true},
			{id:433, pId:4, t:"hideNodes", name:"hideNodes (nodes)", iconSkin:"hide", showAPI:true},
			{id:420, pId:4, t:"moveNode", name:"moveNode (targetNode, vue-example, moveType, isSilent)", iconSkin:"edit", showAPI:true},
			...
			{id:424, pId:4, t:"removeNode", name:"removeNode (vue-example, callbackFlag)", iconSkin:"core", showAPI:true},
			{id:425, pId:4, t:"selectNode", name:"selectNode (vue-example, addFlag, isSilent)", iconSkin:"core", showAPI:true},
			{id:430, pId:4, t:"setChkDisabled", name:"setChkDisabled (vue-example, disabled, inheritParent, inheritChildren)", iconSkin:"check", showAPI:true},
			{id:426, pId:4, t:"setEditable", name:"setEditable (editable)", iconSkin:"edit", showAPI:true},
			{id:434, pId:4, t:"showNode", name:"showNode (vue-example)", iconSkin:"hide", showAPI:true},
			...
			{id:429, pId:4, t:"updateNode", name:"updateNode (vue-example, checkTypeFlag)", iconSkin:"core", showAPI:true},
			{id:5, pId:0, name:"}"}
		];
