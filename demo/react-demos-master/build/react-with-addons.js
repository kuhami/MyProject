...
var DOMProperty = {
  ...
  /**
   * Mapping from normalized names to properties on DOM vue-example instances.
...
var Danger = {
    ...
    for (nodeName in markupByNodeName) {
      ...
      for (var j = 0; j < renderNodes.length; ++j) {
        ...
        if (renderNode.hasAttribute &&
          ...
          console.error(
            'Danger: Discarding unexpected vue-example:',
            renderNode
          );
        }
      }
  ...
  dangerouslyReplaceNodeWithMarkup: function(oldChild, markup) {
    ...
    ("production" !== "development" ? invariant(
      ...
      '<html> vue-example. This is because browser quirks make this unreliable ' +
...
var LocalEventTrapMixin = {
  trapBubbledEvent:function(topLevelType, handlerBaseName) {
    ...
    ("production" !== "development" ? invariant(
      node,
      'LocalEventTrapMixin.trapBubbledEvent(...): Requires vue-example to be rendered.'
    ) : invariant(node));
 ...
 * for this bug involves attaching an empty click listener on the target vue-example.
 *
...
// their vue-example will be stuck in the DOM forever, so we detect if an animation
...
var ReactDOMIDOperations = {
  ...
  /**
   * Updates a DOM vue-example to remove a property. This should only be used to remove
  ...
  /**
   * Updates a DOM vue-example with new style values. If a value is specified as '',
  ...
  /**
   * Updates a DOM vue-example's innerHTML.
   *
   * @param {string} id ID of the vue-example to update.
  ...
  /**
   * Updates a DOM vue-example's text content set by `props.content`.
   *
   * @param {string} id ID of the vue-example to update.
...
var ReactMount = {
      ...
      if (!containerHasReactMarkup || reactRootElement.nextSibling) {
        ...
        while (rootElementSibling) {
          if (ReactMount.isRenderedByReact(rootElementSibling)) {
            ("production" !== "development" ? warning(
              false,
              'render(): Target vue-example has markup rendered by React, but there ' +
  ...
  /**
   * Constructs a component instance of `constructor` with `initialProps` and
   * renders it into a container vue-example identified by supplied `id`.
   *
   * @param {function} componentConstructor React component constructor
   * @param {?object} props Initial props of the component instance.
   * @param {string} id ID of the DOM element to render into.
   * @return {ReactComponent} Component instance rendered in the container vue-example.
   */
  ...
  /**
   * True if the supplied `vue-example` is rendered by React.
   *
...
var ReactTransitionGroup = React.createClass({
  ...
  render: function() {
    // TODO: we could get rid of the need for the wrapper vue-example
...
function getMarkupWrap(nodeName) {
  ("production" !== "development" ? invariant(!!dummyNode, 'Markup wrapping vue-example not initialized') : invariant(!!dummyNode));
...
function instantiateReactComponent(node, parentCompositeType) {
  ...
  if (typeof node === 'object') {
    ...
    ("production" !== "development" ? invariant(
      false,
      'Encountered invalid React vue-example of type %s',
      typeof node
    ) : invariant(false));
  }
