...
Monitor = WeaTools.tryCatch( React, MyErrorHandler, { error: "" })(Monitor);
...
const mapStateToProps = state => {
	const { loading, title } = state.documentMonitor;
...
const mapDispatchToProps = dispatch => {
	return {
		actions: bindActionCreators(MonitorAction, dispatch)
	}
}
